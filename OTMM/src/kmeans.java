...
public class kmeans
{
    public static void main(String[]args) throws IOException
    {
        ...
        pdftotext.selectPDFFiles();
        ppf.main(arg); //PreProcessing of new file
...
//                    System.out.print(clusters.get(cent).add(i));
